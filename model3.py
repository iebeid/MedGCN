...
class Model3(Model):
    ...
    def compile(self):
        ...
        operation1 = DirectedGraphConvolution(input=self.H2.input, graph=self.graph, shape=self.layer_2_dimensions)
        ...
        operation1 = DirectedGraphConvolution(input=self.H3.input, graph=self.graph, shape=self.layer_3_dimensions)
